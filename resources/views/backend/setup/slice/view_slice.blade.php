            ...
            <div class="statbox widget box box-shadow">
                ...
                <div class="widget-content widget-content-area">
                    <div class="table-responsive mb-4">
                        <div class="head">
                            <h3>Tranche</h3>
                            <a href=" {{ route('slice.add') }} " class="btn btn-outline-secondary mb-2">Ajouter</a>
                        </div>
                            ...
                            <tbody>
                                @foreach ($allData as $key => $value)
                                    ...
                                    <tr class="tr_style">
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <p class="align-self-center mb-0 "> {{ $value['student_class']['name'] }}
                                                </p>
                                            </div>
                                        </td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href=" {{ route('slice.detail', $value->class_id) }}   " class="bs-tooltip"
