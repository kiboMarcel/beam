...
@section('admin')
                ...
                <div class="widget-content widget-content-area">
                 ...
                 {{-- GET STATUS FOR SWEET ALERT START --}}
                    ...
                    <div class="head">
                        ...
                        <div class="row header-sec-option">
                            <label for="text">Trimestre</label>
                            <div class="col-lg-3 col-md-3 col-sm-3 ">
                                
                                <select name="season_id" id="season_id" class="custom-select" required>
                                    <option value="" selected="" disabled="">Selectionner trimestre</option>
    ...
    <script>
          $(document).on('click', '#search', function() {
            ...
            feetch(class_id, branch_id, group_id, season_id );
        });

        function feetch(class_id, branch_id, group_id, season_id){
            $.ajax({
                url: "{{ route('student.attendance.get') }}",
                type: "get",
                data: { 'class_id':class_id ,'branch_id': branch_id,'group_id': group_id, 'season_id':season_id },
                beforeSend: function() {  
                    $("#loaderDiv").show();     
                }, 
                complete: function() {
