                            ...
                            <div class="" id="">
                                <div class="">
                                    ...
                                    <table id="style-2" class="table exam-type style-2  ">
                                        {{-- Devoir Marks start --}}
                                        <tbody>
                                            @if ($devoirMarks['0']['exam_type']['name'] == 'Devoir')
                                                <h3 style="margin-top: 37px;">Devoir</h3>
                                                @foreach ($devoirMarks as $item)
                                               
                                                
                                                    <tr class="thead_tr delete_whole_extra_item_add1" id="delete_whole_extra_item_add1">
                                                        <td>
                                                            <div class="d-flex">
                                        ...
                                        <tbody>
                                            ...
                                            @if ($examMarks != 'null')
                                                ...
                                                @foreach ($examMarks as $item)
                                                    <tr class="thead_tr  delete_whole_extra_item_add2" id="delete_whole_extra_item_add2">
                                                        <td>
                                                            <div class="d-flex" >
                                                                <p class="align-self-center mb-0 "> Note </p>
                                                            </div>
                                                        ...
                                                        <td>
                                                            ...
                                                            <div class="d-flex">
                                                                <div class="d-flex">
                                                                    <input type="text" name="e_marks[]" value="{{ $item->marks }}"
                                                                    class="form-control">
                                                                </div>
                                                            </div>
                                                        </td>
