                    ...
                    <div class="row">
                        ...
                        <div class="col-6 col-md-6">
                            <div class="form-group mb-4">
                                ...
                                <input type="date" name="date" value="{{$editData['0']['date']}}" class="form-control" id="formGroupExampleInput" required>
                                @error('name')
                                            ...
                                            <div class="d-flex">
                                                <div class="n-chk">
                                                    <label class="new-control new-radio new-radio-text radio-success" >
                                                      ...
                                                      id="present{{$key}}" value="present"  {{$data->attend_status == 'present' ? 'checked': ''}} checked>
                                                ...
                                                <div class="n-chk">
                                                    <label class="new-control new-radio new-radio-text radio-warning"  >
                                                      <input type="radio"  class="new-control-input" name="attend_status{{$key}}"
                                                      id="retard{{$key}}" value="retard"  {{$data->attend_status == 'retard' ? 'checked': ''}} >
                                                      <span class="new-control-indicator"></span><span class="new-radio-content">Retard</span>
                                                    </label>
                                                </div>
                                                ...
                                                <div class="n-chk">
                                                    <label class="new-control new-radio new-radio-text radio-danger"  >
                                                      <input type="radio"  class="new-control-input" name="attend_status{{$key}}"
                                                      id="absent{{$key}}" value="absent"  {{$data->attend_status == 'absent' ? 'checked': ''}} >
