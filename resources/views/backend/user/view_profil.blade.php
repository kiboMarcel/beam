    ...
    <div class="row layout-top-spacing layout-spacing">
        <div class="col-lg-12">
                    <form method="post" action=" {{ route('profil.update', $user->id) }} " class="section general-info">
                            @csrf
                        <div class="info">
                            <a href="{{ route('profil.password') }}" class="btn btn-warning ">Modifier</a>
                            ...
                            <div class="row">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text"  class="form-control mb-4" id="role"
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="gender" id="select" class="custom-select" required>
                                                                ...
                                                                <option value="masculin"  {{ ($user->gender == "masculin" ? "selected": "") }}>Masuclin</option>
                                ...
                                <button class="btn btn-primary btnC" type="submit">Modifier</button>
                            </div>
                        </div>
                    </form>
                </div>
